...
private:	
	...
	void setSolidData(int i){
		...
		case(5) :	//ICOSAHEDRON
			...
			this->q = 5;
			this->vertexData = {
				/*glm::vec3(t / s, 1.0f / s, 0.0f), glm::vec3(-t, 1.0f, 0.0f), glm::vec3(t, -1.0f, 0.0f),
				glm::vec3(-t / s, -1.0f / s, 0.0f), glm::vec3(1.0f / s, 0.0f, t / s), glm::vec3(1.0f / s, 0.0f, -t / s),
				glm::vec3(-1.0f / s, 0.0f, t / s), glm::vec3(-1.0f / s, 0.0f, -t / s), glm::vec3(0.0f, t / s, 1.0f / s),
				glm::vec3(0.0f, -t / s, 1.0f / s), glm::vec3(0.0f, t / s, -1.0f / s), glm::vec3(0.0f, -t / s, -1.0f / s)
			*/
				glm::vec3(t, 1.0f, 0.0f), glm::vec3(-t, 1.0f, 0.0f), glm::vec3(t, -1.0f, 0.0f),
				glm::vec3(-t, -1.0f, 0.0f), glm::vec3(1.0f, 0.0f, t), glm::vec3(1.0f, 0.0f, -t),
				glm::vec3(-1.0f, 0.0f, t), glm::vec3(-1.0f, 0.0f, -t), glm::vec3(0.0f, t, 1.0f),
				glm::vec3(0.0f, -t, 1.0f), glm::vec3(0.0f, t, -1.0f), glm::vec3(0.0f, -t, -1.0f)
...
public:
	...
	IndexedModel tesselateMesh(int t, IndexedModel m);
